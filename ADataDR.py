...
for i in range(len(remain_gerp)): #i -> gerp
    ...
    remain_qty=remain_gerp.at[i,"Qty Per Assembly"]
    ...
    for j in range(len(npt)):
        ...
        ############### Sheet,Steel(GA) for Tub,Drum(Rear Form) ###############
        elif remain_des=="Sheet,Steel(GA)" and remain_parent=='MJT63706001' and npt_des=='Tub,Drum(Rear Form)':
            match_list.at[match_number,"gerp_re"]=remain_seq
            remain_match.at[count,"index"]=i
            count=count+1

        ############### Sheet,Steel(GA) for Tub,Drum(Front Form) ###############
        elif remain_des=="Sheet,Steel(GA)" and remain_parent=='MJT63705901' and npt_des=='Tub,Drum(Front Form)':
            match_list.at[match_number,"gerp_re"]=remain_seq
            remain_match.at[count,"index"]=i
            count=count+1

        ############### Screw Tapping ###############
        elif remain_des=="Screw,Tapping" and npt_parent=='TAV35812101' and npt_part==remain_part and npt_qty==remain_qty:
            match_list.at[match_number,"gerp_re"]=remain_seq
            remain_match.at[count,"index"]=i
            count=count+1
