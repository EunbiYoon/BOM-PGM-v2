...
title='[테네시 재료비 관리 Task] 6월 5주차 BOM과 실제 생산 투입 재료비 차이 분석'
################################## Send email ################################## 
...
save_path='C:/Users/RnD Workstation/Documents/NPTGERP/0628/'

# graph file read
with open(save_path+'FL_0628.png', 'rb') as f:
        img_data = f.read()
image2 = MIMEImage(img_data, name=os.path.basename("FL.png"))

with open(save_path+'TL_0628.png', 'rb') as f:
        img_data = f.read()
image1 = MIMEImage(img_data, name=os.path.basename("TL.png"))

with open(save_path+'DR_0628.png', 'rb') as f:
        img_data = f.read()
...
#첨부 파일
etcFileName='Cost Review_0628.xlsx'
with open("C:/Users/RnD Workstation/Documents/NPTGERP/0628/result_0628.xlsx", 'rb') as etcFD : 
    etcPart = MIMEApplication( etcFD.read() )
    #첨부파일의 정보를 헤더로 추가
    etcPart.add_header('Content-Disposition','attachment', filename=etcFileName)
    msg.attach(etcPart)

etcFileName='BOM Comparison_FL_0628.xlsx'
with open("C:/Users/RnD Workstation/Documents/NPTGERP/0628/BOM Comparison_FL.xlsx", 'rb') as etcFD : 
    etcPart = MIMEApplication( etcFD.read() )
    #첨부파일의 정보를 헤더로 추가
    etcPart.add_header('Content-Disposition','attachment', filename=etcFileName)
    msg.attach(etcPart)

etcFileName='BOM Comparison_TL_0628.xlsx'
with open("C:/Users/RnD Workstation/Documents/NPTGERP/0628/BOM Comparison_TL.xlsx", 'rb') as etcFD : 
    etcPart = MIMEApplication( etcFD.read() )
    #첨부파일의 정보를 헤더로 추가
    etcPart.add_header('Content-Disposition','attachment', filename=etcFileName)
    msg.attach(etcPart)

etcFileName='BOM Comparison_DR_0628.xlsx'
with open("C:/Users/RnD Workstation/Documents/NPTGERP/0628/BOM Comparison_DR.xlsx", 'rb') as etcFD : 
    etcPart = MIMEApplication( etcFD.read() )
    #첨부파일의 정보를 헤더로 추가
    etcPart.add_header('Content-Disposition','attachment', filename=etcFileName)
    msg.attach(etcPart)
